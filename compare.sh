...
usage() {
    cat << EOT 1>&2
Usage: compare.sh [-dhlqz] [-a algo] [-e prog] [-k kdf] [-o org] [-p fn] [-x ext] dir
...
ARGUMENTS
=========
dir          directory containing LastPass export
...
compare_lastpass_export() {
    local file_list
    local -i num_items
    local -i counter
    local file_name

    debug "Comparing exported LastPass items to Bitwarden."
